...
from utils.constants import PAD_TOK
from .DecoderRNN import DecoderRNN
from .EncoderRNN import EncoderRNN
from .Seq2Seq import Seq2seq
from .Attention import BahdanauAttention
from base import BaseModel
from utils.sequence import encode_input, toTensor
import torch
...
class ReversingModel(BaseModel):
    ...
    def predict(self, src_seq):
        ...
        encoded_input = encode_input([src_seq.strip("\n")],self.src_vocab)
        src_id_seq = toTensor(encoded_input, self.encoder.device,self.src_vocab.stoi[PAD_TOK])
